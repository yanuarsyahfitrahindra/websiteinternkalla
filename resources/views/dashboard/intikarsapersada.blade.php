...
<html lang="en">
    <div class="col-lg-4 col-md-6">
        <div class="card card-chart" style="background-color: #0C783E; font-size:10px; font-size:10px">
            <div class="card-header">
                ...
                <h4 class="card-title">Peserta Magang Hadji Kalla</h4>
                <center>
    ...
    <div class="col-lg-4 col-md-6">
        <div class="card card-chart" style="background-color: #0C783E; font-size:10px">
            <div class="card-header">
                <h5 class="card-category">Terhitung saat ini, Hadji Kalla memiliki:</h5>
    ...
    <div class="col-lg-4 col-md-6">
        <div class="card card-chart" style="background-color: #0C783E; font-size:10px; font-size:10px">
            <div class="card-header">
                <h5 class="card-category">Inti Karsa Persada memiliki:</h5>
